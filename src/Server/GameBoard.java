...
public class GameBoard {
	...
	public static int checkBoardSettings(int numS, int row, int col, String command) {
		...
		if (command.equals("linhas") || command.equals("colunas")) {
			...
			min = numS; // e criado o objeto inteiro min_shots que e igual ao numare de celulas ocupadas
						// pelos
			// navios
		}
		...
		while (val) // enquanto val_row for verdadeiro o sistema ira correr as instrucoes dentro do
					// ciclo while
		{
			...
			if (scan.hasNextInt()) // verifica se o jogador inseriu um numero inteiro
			{
				...
				if (value >= min && value <= max) // verifica que o numero inteiro inserido esta entre os limites
													// definidos
				{
				...
				else // caso o jogador inserir um numero inteiro fora dos limites definidos
				{
					...
					// val_row continua igual a true, ciclo repete-se até jogador inserir um numero
					// inteiro valido
				}
			}
	...
	public static int[] generateCoordinates(int ship_type, int orientation, int row, int col) {
		...
		int c1 = 0; // c1 vai ser o primeiro elemento do vetor coordenadas_navio, correspondente à
					// linha
		int c2 = 0; // c2 vai ser o segundo elemento do vetor coordenadas_navio, correspondente à
					// coluna
